...
export const ui = {
  ...
  nav: {
    ...
    pdfReports: { es: "Reportes PDF", en: "PDF Reports" },
  ...
  admin: {
    ...
    subtitle: {
      es: "Gestión interna de usuarios, suscripciones y planes.",
      en: "Internal management of users, subscriptions and plans.",
    },
    tabOverview: { es: "Resumen", en: "Overview" },
    tabUsers: { es: "Usuarios", en: "Users" },
    tabSubscriptions: { es: "Suscripciones", en: "Subscriptions" },
    tabPlans: { es: "Planes", en: "Plans" },
    modeBadge: { es: "Modo administrador", en: "Admin mode" },
    backToApp: { es: "Volver a la app", en: "Back to the app" },
    overviewSubtitle: {
      es: "Un vistazo rápido al estado del negocio.",
      en: "A quick look at the state of the business.",
    },
    usersSubtitle: {
      es: "Buscá, editá y gestioná el plan de cualquier cuenta.",
      en: "Search, edit and manage any account's plan.",
    },
    subscriptionsSubtitle: {
      es: "Todas las suscripciones de Mercado Pago, filtrables por estado.",
      en: "All Mercado Pago subscriptions, filterable by status.",
    },
    plansSubtitle: {
      es: "Precios y límites de cada plan disponible.",
      en: "Pricing and limits for each available plan.",
    },

    totalUsers: { es: "Usuarios totales", en: "Total users" },
    activeSubscriptions: { es: "Suscripciones activas", en: "Active subscriptions" },
    mrr: { es: "Ingreso mensual recurrente", en: "Monthly recurring revenue" },
    usersByPlan: { es: "Usuarios por plan", en: "Users by plan" },

    searchPlaceholder: {
      es: "Buscar por nombre, apellido o email…",
      en: "Search by name, last name or email…",
    },
    ...
    deleteUserConfirm: {
      es: "¿Eliminar esta cuenta? Esta acción no se puede deshacer.",
      en: "Delete this account? This action cannot be undone.",
    },
    assignPlan: { es: "Asignar plan", en: "Assign plan" },
    cancelPlan: { es: "Cancelar plan", en: "Cancel plan" },
    cancelPlanConfirm: {
      es: "¿Cancelar la renovación del plan de este usuario? Seguirá activo hasta que venza.",
      en: "Cancel this user's plan renewal? It stays active until it expires.",
    },
    viewHistory: { es: "Historial", en: "History" },
    noUsers: { es: "No se encontraron usuarios.", en: "No users found." },

    columnName: { es: "Nombre", en: "Name" },
    columnUsername: { es: "Usuario", en: "Username" },
    columnPlan: { es: "Plan", en: "Plan" },
    columnExpires: { es: "Vence", en: "Expires" },
    columnAutoRenew: { es: "Renueva", en: "Renews" },
    columnStatus: { es: "Estado", en: "Status" },
    columnActions: { es: "Acciones", en: "Actions" },
    noExpiry: { es: "Sin vencimiento", en: "No expiry" },
    yes: { es: "Sí", en: "Yes" },
    no: { es: "No", en: "No" },

    userFormName: { es: "Nombre", en: "Name" },
    userFormLastName: { es: "Apellido", en: "Last name" },
    userFormUsername: { es: "Email / usuario", en: "Email / username" },
    userFormPassword: { es: "Contraseña", en: "Password" },
    userFormPasswordEditHint: {
      es: "Se va a actualizar la contraseña de la cuenta.",
      en: "This will update the account's password.",
    },

    assignPlanTarget: { es: "Plan", en: "Plan" },
    assignPlanDuration: {
      es: "Duración en días (opcional)",
      en: "Duration in days (optional)",
    },
    assignPlanDurationHint: {
      es: "Dejalo vacío para usar la duración por defecto del plan.",
      en: "Leave empty to use the plan's default duration.",
    },
    assignPlanConfirm: { es: "Asignar", en: "Assign" },

    historyTitle: { es: "Historial de suscripciones", en: "Subscription history" },
    historyEmpty: {
      es: "Este usuario todavía no tuvo suscripciones.",
      en: "This user hasn't had any subscriptions yet.",
    },

    statusAll: { es: "Todos los estados", en: "All statuses" },
    statusAuthorized: { es: "Autorizada", en: "Authorized" },
    statusPending: { es: "Pendiente", en: "Pending" },
    statusPaused: { es: "Pausada", en: "Paused" },
    statusCancelled: { es: "Cancelada", en: "Cancelled" },
    noSubscriptions: { es: "No hay suscripciones para este filtro.", en: "No subscriptions for this filter." },
    columnUser: { es: "Usuario", en: "User" },
    columnNextPayment: { es: "Próximo cobro", en: "Next payment" },
    columnCreatedAt: { es: "Creada", en: "Created" },

    pagePrev: { es: "Anterior", en: "Previous" },
    pageNext: { es: "Siguiente", en: "Next" },
    pageWord: { es: "Página", en: "Page" },
    pageOf: { es: "de", en: "of" },

    createPlan: { es: "Crear plan", en: "Create plan" },
    editPlan: { es: "Editar plan", en: "Edit plan" },
    deletePlan: { es: "Eliminar plan", en: "Delete plan" },
    deletePlanConfirm: {
      es: "¿Eliminar este plan? Los usuarios que lo tengan asignado no se ven afectados retroactivamente.",
      en: "Delete this plan? Users already on it are not retroactively affected.",
    },
    columnMaxProducts: { es: "Máx. productos", en: "Max products" },
    columnPrice: { es: "Precio", en: "Price" },
    columnDuration: { es: "Duración (días)", en: "Duration (days)" },
    planFormName: { es: "Nombre interno", en: "Internal name" },
    planFormMaxProducts: { es: "Máximo de productos", en: "Max products" },
    planFormPrice: { es: "Precio", en: "Price" },
    planFormDuration: { es: "Duración en días", en: "Duration in days" },
  },
  panel: {
  ...
  products: {
    ...
    descriptionHint: {
      es: "Opcional. Hasta 150 caracteres.",
      en: "Optional. Up to 150 characters.",
    },
  ...
  categories: {
    ...
    totalProducts: { es: "Productos", en: "Products" },
    viewProducts: { es: "Ver productos", en: "View products" },
  ...
  plans: {
    ...
    productsUnit: { es: "productos", en: "products" },
  ...
  pdfReports: {
    title: { es: "Reportes PDF", en: "PDF Reports" },
    subtitle: {
      es: "Generá reportes en PDF de tu inventario.",
      en: "Generate PDF reports of your inventory.",
    },
    summaryTitle: { es: "Resumen ejecutivo", en: "Executive summary" },
    summaryDescription: {
      es: "KPIs generales, distribución por categoría y productos críticos.",
      en: "General KPIs, category breakdown and critical products.",
    },
    lowStockTitle: { es: "Alerta de stock bajo", en: "Low stock alert" },
    lowStockDescription: {
      es: "Productos por debajo del stock mínimo, agrupados por sucursal.",
      en: "Products below minimum stock, grouped by branch.",
    },
    movementsTitle: { es: "Movimientos", en: "Movements" },
    movementsDescription: {
      es: "Historial de movimientos filtrado por fecha, sucursal y más.",
      en: "Movement history filtered by date, branch and more.",
    },
    generate: { es: "Generar PDF", en: "Generate PDF" },
    generating: { es: "Generando PDF…", en: "Generating PDF…" },
    proRequired: {
      es: "Necesitás un plan PRO para exportar reportes.",
      en: "You need a PRO plan to export reports.",
    },
    noData: {
      es: "No se encontraron datos para generar el reporte.",
      en: "No data found to generate the report.",
    },
    lowStockCount: { es: "productos con stock bajo", en: "products with low stock" },
    allBranches: { es: "Todas", en: "All" },
    lowStockOnly: { es: "Solo stock bajo", en: "Low stock only" },
    allProducts: { es: "Todos los productos activos", en: "All active products" },
    sections: { es: "Secciones", en: "Sections" },
    allSections: { es: "Todas", en: "All" },
    periodDays: { es: "Período (días)", en: "Period (days)" },
    sectionKpi: { es: "KPIs generales", en: "General KPIs" },
    sectionCategoryBreakdown: { es: "Distribución por categoría", en: "Category breakdown" },
    sectionCriticalStock: { es: "Stock crítico", en: "Critical stock" },
    sectionTopMovers: { es: "Más movimiento", en: "Top movers" },
    sectionNoMovement: { es: "Sin movimiento", en: "No movement" },
    sectionNewProducts: { es: "Productos nuevos", en: "New products" },
    sectionMovementSummary: { es: "Resumen de movimientos", en: "Movement summary" },
  },
  contact: {
